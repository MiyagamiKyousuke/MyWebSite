	...
	<div class="container">
		<table class="table">
			...
			<tr>
				...
				<th scope="col">${item.cardTypeName}</th>
				<th scope="col"><div class="input-group-prepend">
						<input type="text" id="${item.id}" name="${item.id}" value="${item.stock}"
		...
		<form action="ItemStockInsert" method="post" name="updateStock">
